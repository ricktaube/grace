...
;    (ffi_ranseed           void "cm_ranseed" integer64) ; old api
    ...
    ;;; OSC
    (ffi_osc_open_input bool "osc_open_input" int)
    (ffi_osc_close_input bool "osc_close_input" )
    (ffi_osc_open_output bool "osc_open_output" c-string int)
    (ffi_osc_close_output bool "osc_close_output" )
